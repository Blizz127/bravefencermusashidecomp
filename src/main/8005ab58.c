/* Exact retail word export for [8005AB58,8005AC24); EXE and assembly verified. */
...
MUSASHI_NATIVE_MIPS_WORD(0x08016ae6)
...
MUSASHI_NATIVE_MIPS_WORD(0x00000000)
MUSASHI_NATIVE_MIPS_WORD(0x08016af6)
