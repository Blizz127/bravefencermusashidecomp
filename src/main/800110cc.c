/* Exact retail word export for [800110CC,80011144); EXE and assembly verified. */
...
MUSASHI_NATIVE_MIPS_WORD(0x2484E880)
 ...
 * (30/30 words at 0x800110CC, -O0). Types and signatures are whatever
...
void func_800110CC(void) {
    ...
    (void) pad;
    func_8001A9F8(0);
    if (func_80019A24(&D_800AE880, D_80072C70, 0, 0) != 0) {
        func_80010AE0(0x3E0);
        func_80011778();
        func_80015310();
    }
