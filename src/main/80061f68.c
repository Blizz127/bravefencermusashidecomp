/* Exact retail word export for [80061F68,80061F74); EXE and assembly verified. */
#ifdef MUSASHI_NATIVE_MIPS_WORD_EXPORT
MUSASHI_NATIVE_MIPS_WORD(0x240a00b0)
MUSASHI_NATIVE_MIPS_WORD(0x01400008)
MUSASHI_NATIVE_MIPS_WORD(0x24090036)
#else
/* Verified byte-exact against retail by tools/match_function.py
 * (3/3 words at 0x80061F68). Types and signatures are whatever
...
__asm__(
    ".set noreorder\n"
    ".globl func_80061F68\n"
    ".type func_80061F68, @function\n"
    "func_80061F68:\n"
    "addiu $t2,$zero,0xB0\n"
    "jr $t2\n"
    "addiu $t1,$zero,0x36\n"
    ".size func_80061F68, .-func_80061F68\n"
    ".set reorder\n"
);
#endif
