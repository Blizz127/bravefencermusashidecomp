/* Exact retail word export for [80061F58,80061F64); EXE and assembly verified. */
#ifdef MUSASHI_NATIVE_MIPS_WORD_EXPORT
MUSASHI_NATIVE_MIPS_WORD(0x240a00b0)
MUSASHI_NATIVE_MIPS_WORD(0x01400008)
MUSASHI_NATIVE_MIPS_WORD(0x24090033)
#else
/* Verified byte-exact against retail by tools/match_function.py
 * (3/3 words at 0x80061F58). Types and signatures are whatever
...
__asm__(
    ".set noreorder\n"
    ".globl func_80061F58\n"
    ".type func_80061F58, @function\n"
    "func_80061F58:\n"
    "addiu $t2,$zero,0xB0\n"
    "jr $t2\n"
    "addiu $t1,$zero,0x33\n"
    ".size func_80061F58, .-func_80061F58\n"
    ".set reorder\n"
);
#endif
