/* Exact retail word export for [80062698,800626A4); EXE and assembly verified. */
 ...
 * (3/3 words at 0x80062698). Types and signatures are whatever
...
__asm__(
    ".set noreorder\n"
    ".globl func_80062698\n"
    ".type func_80062698, @function\n"
    "func_80062698:\n"
    "addiu $t2,$zero,0xB0\n"
    "jr $t2\n"
    "addiu $t1,$zero,0x13\n"
    ".size func_80062698, .-func_80062698\n"
    ".set reorder\n"
);
#endif
