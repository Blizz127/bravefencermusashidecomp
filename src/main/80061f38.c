/* Exact retail word export for [80061F38,80061F44); EXE and assembly verified. */
#ifdef MUSASHI_NATIVE_MIPS_WORD_EXPORT
MUSASHI_NATIVE_MIPS_WORD(0x240a00a0)
MUSASHI_NATIVE_MIPS_WORD(0x01400008)
MUSASHI_NATIVE_MIPS_WORD(0x24090070)
#else
/* Verified byte-exact against retail by tools/match_function.py
 * (3/3 words at 0x80061F38). Types and signatures are whatever
...
__asm__(
    ".set noreorder\n"
    ".globl func_80061F38\n"
    ".type func_80061F38, @function\n"
    "func_80061F38:\n"
    "addiu $t2,$zero,0xA0\n"
    "jr $t2\n"
    "addiu $t1,$zero,0x70\n"
    ".size func_80061F38, .-func_80061F38\n"
    ".set reorder\n"
);
#endif
