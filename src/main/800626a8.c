/* Exact retail word export for [800626A8,800626B4); EXE and assembly verified. */
#ifdef MUSASHI_NATIVE_MIPS_WORD_EXPORT
MUSASHI_NATIVE_MIPS_WORD(0x240a00b0)
MUSASHI_NATIVE_MIPS_WORD(0x01400008)
MUSASHI_NATIVE_MIPS_WORD(0x24090014)
#else
/* Verified byte-exact against retail by tools/match_function.py
 * (3/3 words at 0x800626A8). Types and signatures are whatever
...
__asm__(
    ".set noreorder\n"
    ".globl func_800626A8\n"
    ".type func_800626A8, @function\n"
    "func_800626A8:\n"
    "addiu $t2,$zero,0xB0\n"
    "jr $t2\n"
    "addiu $t1,$zero,0x14\n"
    ".size func_800626A8, .-func_800626A8\n"
    ".set reorder\n"
);
#endif
