/* Exact retail word export for [80062268,80062274); EXE and assembly verified. */
#ifdef MUSASHI_NATIVE_MIPS_WORD_EXPORT
MUSASHI_NATIVE_MIPS_WORD(0x240a00a0)
MUSASHI_NATIVE_MIPS_WORD(0x01400008)
MUSASHI_NATIVE_MIPS_WORD(0x240900ac)
#else
/* Verified byte-exact against retail by tools/match_function.py
 * (3/3 words at 0x80062268). Types and signatures are whatever
...
__asm__(
    ".set noreorder\n"
    ".globl func_80062268\n"
    ".type func_80062268, @function\n"
    "func_80062268:\n"
    "addiu $t2,$zero,0xA0\n"
    "jr $t2\n"
    "addiu $t1,$zero,0xAC\n"
    ".size func_80062268, .-func_80062268\n"
    ".set reorder\n"
);
#endif
