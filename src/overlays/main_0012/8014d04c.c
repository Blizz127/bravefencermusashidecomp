/* Overlay range [8014D04C,8014D0A4) from MAIN.CD member 0012.
 * SHA256(span)=7b6d53ff357efd5634255cc1198fd98050c9e5ae18a4b241e395a9e6f629dab1.
...
MUSASHI_NATIVE_MIPS_WORD(0x0C053429)
MUSASHI_NATIVE_MIPS_WORD(0x00000000)
...
s32 func_8014D0A4();                                /* static */

s32 func_8014D04C(void) {
    **(void ***)0x1F8003FC = sp;
    D_80184248 = func_8014D0A4();
    return D_80184248;
}
#endif
