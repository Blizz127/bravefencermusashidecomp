/* Exact retail word export for [8005CEB8,8005CEC4); EXE and assembly verified. */
#ifdef MUSASHI_NATIVE_MIPS_WORD_EXPORT
MUSASHI_NATIVE_MIPS_WORD(0x240a00b0)
MUSASHI_NATIVE_MIPS_WORD(0x01400008)
MUSASHI_NATIVE_MIPS_WORD(0x2409000c)
#else
/* Verified byte-exact against retail by tools/match_function.py
 * (3/3 words at 0x8005CEB8). Types and signatures are whatever
...
__asm__(
    ".set noreorder\n"
    ".globl func_8005CEB8\n"
    ".type func_8005CEB8, @function\n"
    "func_8005CEB8:\n"
    "addiu $t2,$zero,0xB0\n"
    "jr $t2\n"
    "addiu $t1,$zero,0xC\n"
    ".size func_8005CEB8, .-func_8005CEB8\n"
    ".set reorder\n"
);
#endif
