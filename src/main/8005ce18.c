/* Exact retail word export for [8005CE18,8005CE24); EXE and assembly verified. */
#ifdef MUSASHI_NATIVE_MIPS_WORD_EXPORT
MUSASHI_NATIVE_MIPS_WORD(0x240a00a0)
MUSASHI_NATIVE_MIPS_WORD(0x01400008)
MUSASHI_NATIVE_MIPS_WORD(0x24090039)
#else
/* Verified byte-exact against retail by tools/match_function.py
 * (3/3 words at 0x8005CE18). Types and signatures are whatever
...
__asm__(
    ".set noreorder\n"
    ".globl func_8005CE18\n"
    ".type func_8005CE18, @function\n"
    "func_8005CE18:\n"
    "addiu $t2,$zero,0xA0\n"
    "jr $t2\n"
    "addiu $t1,$zero,0x39\n"
    ".size func_8005CE18, .-func_8005CE18\n"
    ".set reorder\n"
);
#endif
