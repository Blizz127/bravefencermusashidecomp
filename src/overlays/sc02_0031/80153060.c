/* SC02.CD FILE_031 / ov_SC02_031 retail span [80153060,8015309C).
 * Offset 0x2AF08 at overlay base 80128158. SHA256(span)=c72ce6968bdc68763ab7aaae97a679cfba00fe42c1ab114b3de1caa1ea2a338b.
...
MUSASHI_NATIVE_MIPS_WORD(0x8C2209D8)
MUSASHI_NATIVE_MIPS_WORD(0x00000000)
...
#include "psx_types.h"
typedef void (*CB)();
extern CB D_801809D8[];
typedef struct { u8 pad[2]; u16 idx; } T;
void func_80153060(T *p) {
    D_801809D8[p->idx](p);
}
#endif
