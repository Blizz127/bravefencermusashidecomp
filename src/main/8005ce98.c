/* Exact retail word export for [8005CE98,8005CEA4); EXE and assembly verified. */
 ...
 * (3/3 words at 0x8005CE98). Types and signatures are whatever
...
__asm__(
    ".set noreorder\n"
    ".globl func_8005CE98\n"
    ".type func_8005CE98, @function\n"
    "func_8005CE98:\n"
    "addiu $t2,$zero,0xB0\n"
    "jr $t2\n"
    "addiu $t1,$zero,0xA\n"
    ".size func_8005CE98, .-func_8005CE98\n"
    ".set reorder\n"
);
#endif
