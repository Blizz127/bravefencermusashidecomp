/* Main-exec range [8001C744,8001C7B0) from the SLUS executable.
 * SHA256(span)=817682816b85634b4f67074092cd2b42f71498ff0544c549e162cc4872880266.
...
MUSASHI_NATIVE_MIPS_WORD(0xAE120024)
