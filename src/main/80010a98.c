/* Exact retail word export for [80010A98,80010AE0); EXE and assembly verified. */
#ifdef MUSASHI_NATIVE_MIPS_WORD_EXPORT
MUSASHI_NATIVE_MIPS_WORD(0x27BDFFE8)
MUSASHI_NATIVE_MIPS_WORD(0xAFBF0014)
MUSASHI_NATIVE_MIPS_WORD(0xAFBE0010)
MUSASHI_NATIVE_MIPS_WORD(0x03A0F021)
MUSASHI_NATIVE_MIPS_WORD(0x3C048001)
MUSASHI_NATIVE_MIPS_WORD(0x2484099C)
MUSASHI_NATIVE_MIPS_WORD(0x0C01657F)
MUSASHI_NATIVE_MIPS_WORD(0x00000000)
MUSASHI_NATIVE_MIPS_WORD(0x3C048001)
MUSASHI_NATIVE_MIPS_WORD(0x2484096C)
