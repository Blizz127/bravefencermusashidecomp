/* Main-exec range [8001125C,800112A8) from the SLUS executable.
 * SHA256(span)=499a6bf2968d7abf765c4792d2b393566183f1ae491297a431ddfeb0bc03c130.
...
/* func_8001125C - 19 words. Promoted from vendor/bfm-decomp
