/* Exact retail word export for [8005CE78,8005CE84); EXE and assembly verified. */
 ...
 * (3/3 words at 0x8005CE78). Types and signatures are whatever
...
__asm__(
    ".set noreorder\n"
    ".globl func_8005CE78\n"
    ".type func_8005CE78, @function\n"
    "func_8005CE78:\n"
    "addiu $t2,$zero,0xB0\n"
    "jr $t2\n"
    "addiu $t1,$zero,0x8\n"
    ".size func_8005CE78, .-func_8005CE78\n"
    ".set reorder\n"
);
#endif
