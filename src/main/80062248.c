/* Exact retail word export for [80062248,80062254); EXE and assembly verified. */
#ifdef MUSASHI_NATIVE_MIPS_WORD_EXPORT
MUSASHI_NATIVE_MIPS_WORD(0x240a00b0)
MUSASHI_NATIVE_MIPS_WORD(0x01400008)
MUSASHI_NATIVE_MIPS_WORD(0x24090042)
#else
/* Verified byte-exact against retail by tools/match_function.py
 * (3/3 words at 0x80062248). Types and signatures are whatever
...
__asm__(
    ".set noreorder\n"
    ".globl func_80062248\n"
    ".type func_80062248, @function\n"
    "func_80062248:\n"
    "addiu $t2,$zero,0xB0\n"
    "jr $t2\n"
    "addiu $t1,$zero,0x42\n"
    ".size func_80062248, .-func_80062248\n"
    ".set reorder\n"
);
#endif
