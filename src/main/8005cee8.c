/* Exact retail word export for [8005CEE8,8005CEF4); EXE and assembly verified. */
#ifdef MUSASHI_NATIVE_MIPS_WORD_EXPORT
MUSASHI_NATIVE_MIPS_WORD(0x240a00b0)
MUSASHI_NATIVE_MIPS_WORD(0x01400008)
MUSASHI_NATIVE_MIPS_WORD(0x24090018)
#else
/* Verified byte-exact against retail by tools/match_function.py
 * (3/3 words at 0x8005CEE8). Types and signatures are whatever
...
__asm__(
    ".set noreorder\n"
    ".globl func_8005CEE8\n"
    ".type func_8005CEE8, @function\n"
    "func_8005CEE8:\n"
    "addiu $t2,$zero,0xB0\n"
    "jr $t2\n"
    "addiu $t1,$zero,0x18\n"
    ".size func_8005CEE8, .-func_8005CEE8\n"
    ".set reorder\n"
);
#endif
