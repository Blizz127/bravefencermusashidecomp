/* Main-exec range [80010BB4,80010C7C) from the SLUS executable.
 * SHA256(span)=a7ad60f57b2a18feaa2bd47d75a9a3685c05ed033ea9ac85abbcac1eefc14b4f.
...
/* func_80010BB4 - 50 words. Promoted from vendor/bfm-decomp
