...
s32 func_800435CC(s32 arg0, s32 arg1, s32 arg2) {
    s32 temp_s3;
    s32 temp_s5;
    s32 var_s0;
    s32 var_v0;
...
loop_1:
    ...
    if (((arg1 != 0) && (*((temp_s3 * 4) + D_8006CBFC) != 0) && (func_80044670(2, arg1, arg2, 0) != 0)) || (D_8006CC84 = temp_s5, var_v0 = 1, (func_80044670(arg0 & 0xFF, arg1, arg2, 0) != 0))) {
        var_s0 -= 1;
        if (var_s0 == -1) {
            D_8006CC84 = temp_s5;
            var_v0 = 0;
